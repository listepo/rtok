...
| `rtok agents setup claude\|cursor\|codex\|opencode\|pi` | install into a host, with backups; `--dry-run` |
| `rtok agents remove claude\|cursor\|codex\|opencode\|pi` | take rtok back out of a host, with backups; `--dry-run` |
