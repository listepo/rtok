...
| `rtok agents install claude\|cursor\|codex\|opencode\|pi\|zcode\|kimi\|copilot\|aider\|windsurf\|zed` | install into a host, with backups; `--dry-run` |
| `rtok agents uninstall claude\|cursor\|codex\|opencode\|pi\|zcode\|kimi\|copilot\|aider\|windsurf\|zed` | take rtok back out of a host, with backups; `--dry-run` |
