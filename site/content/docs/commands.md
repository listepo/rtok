...
| `rtok agents install claude\|cursor\|codex\|opencode\|pi\|zcode\|kimi\|copilot\|aider` | install into a host, with backups; `--dry-run` |
| `rtok agents remove claude\|cursor\|codex\|opencode\|pi\|zcode\|kimi\|copilot\|aider` | take rtok back out of a host, with backups; `--dry-run` |
