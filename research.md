...
| Assistant thinking blocks (T125, 2026-09-21, `rtok stats --since 30d`, 825 sessions) | 48 thinking blocks, 99,491 bytes ≈ 24,873 est. tokens, **3.7 % of session input** — at the 3 % gate. Note: Anthropic's API drops thinking blocks from prior assistant turns in context window (per https://docs.claude.com/en/docs/build-with-claude/extended-thinking), so replay cost is ~0 regardless of transcript share. |
