...
**Status.** Lane done — T14.9, T8.1–T8.19 done (P8 / P8b / P8c / P8d); Gate P8 passed 2026-09-03; Gate P8b closed 2026-09-09 on the three code clauses; Gate P8c: `graph-lbug` stays opt-in (2026-09-08); Gate P8d passed 2026-09-09. See `done.md` P8*.
