...
T15.0 (the shared model) is done 2026-09-09 — see `done.md` P15. It serves the two pages `rtok web`
has today, Overview and Plugins; Calls, Doctor and Logs join the model with T15.5–T15.7.
