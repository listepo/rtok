...
### P17 — build size (goal: what a contributor compiles and what a user downloads stop growing with the dependency list) — added 2026-09-04; task done, gate open on one clause
