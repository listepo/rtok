...
/// The `/plugins install <resolved plugins/kimi path>` line (T86): dry-run and
/// apply alike print it, rtok never writes `plugins/managed/` or
/// `installed.json` — that format is Kimi's and undocumented.
