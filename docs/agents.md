...
| --- | --- | --- | --- | --- | --- | --- | --- |
| [`claude`](https://github.com/listepo/rtok/blob/main/src/agents/claude/README.md) | Claude Code | CLI | yes | yes | `--proxy` | `--yes` | measure, cmd, read, archive, proxy, inject, guard, memory, graph, toon (off), compress (off) |
